...
from .custom_agent_dynamics_with_scripted_prey import CustomAgent, CustomWorld # Ronchy自定义的World类，用于测试自定义的智能体动力学模型
...
class Scenario(BaseScenario):
    def make_world(self, num_good=1, num_adversaries=3, num_obstacles=2, _world_size=2.5):
        ...
        # V4环境特性
        world.observation_radius = _world_size * 0.3
