...
与v4_partially的不同：增加 debug_collision_rendering ，查看碰撞的边界接触效果
...
class Custom_raw_env(SimpleEnv, EzPickle):
    def __init__(
        ...
        self.metadata["name"] = "simple_tag_env_v4_partially_debug"
        # Ronchy添加轨迹记录
...
class Scenario(BaseScenario):
    def make_world(self, num_good=1, num_adversaries=3, num_obstacles=2, _world_size=2.5):
        ...
        # V4环境特性
        world.observation_radius = _world_size * 0.3  # # 添加观测半径，半径是世界大小的30%
